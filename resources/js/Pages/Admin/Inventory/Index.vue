            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="overflow-hidden rounded-lg bg-white p-6 shadow-sm">
                    <p class="mb-4 text-sm text-gray-500">
                        ...
                        ledger as type <code class="rounded bg-gray-100 px-1">adjustment</code>
                        ...
                        <tbody>
                            <template v-for="product in products.data" :key="product.id">
                                <tr class="border-t border-gray-100">
                                    ...
                                    <td class="py-2 text-gray-500">{{ product.reorder_threshold }}</td>
                                ...
                                <tr v-if="openRowId === product.id" class="border-t border-gray-100 bg-gray-50">
                                        ...
                                        >
                                            <div>
                                                <input
                                                    ...
                                                    class="w-32 rounded-md border-gray-300 text-sm shadow-sm focus:border-green-500 focus:ring-green-500"
                                                />
                                                <p v-if="errors.delta" class="mt-1 text-xs text-red-600">
                                                    {{ errors.delta }}
                                                </p>
                                            </div>
                                            <div class="flex-1">
