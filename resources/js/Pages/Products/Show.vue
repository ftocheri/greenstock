    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <Link :href="route('products.index')" class="text-sm text-green-700 hover:underline">
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                <div class="grid grid-cols-2 gap-6 rounded-lg bg-white p-6 shadow-sm sm:grid-cols-4">
                    <div>
                    ...
                    <div>
                        ...
                        <div
                            class="font-medium"
                            :class="product.current_stock <= product.reorder_threshold ? 'text-amber-600' : 'text-gray-900'"
                        >
                    ...
                    <div>
                        ...
                        <div class="font-medium text-gray-900">{{ product.supplier?.name }}</div>
                    </div>
                </div>

                <div v-if="product.description" class="rounded-lg bg-white p-6 shadow-sm">
                    ...
                    <table class="w-full text-left text-sm">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="py-2 text-gray-900">{{ movement.quantity }}</td>
                                <td class="py-2 text-gray-500">{{ movement.source }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
